...
//--------------------------- KDU_NO_CPUID_TEST -------------------------------
  ...
  bool kdu_get_sparcvis_exists() { return false; }
  bool kdu_get_altivec_exists() { return false; }
...
//---------------------- Microsoft System, 64-bit X86 -------------------------
  ...
  int kdu_get_mmx_level() { return x64_get_mmx_level(); }
...
//---------------------- Microsoft System, 32-bit X86 -------------------------
  ...
  int kdu_get_mmx_level() { return get_mmx_level(); }
      ...
      if ((result == 2) && (ecx_val & 1))
        {
          ...
          if (ecx_val & 0x00000200)
            { 
              ...
              if (ecx_val & 0x00080000)
                result = 5; // SSE4.1 support exists
            }
        }
#  ifndef KDU_NO_AVX
...
//--------------------------- KDU_SPARCVIS_GCC --------------------------------
  ...
  bool kdu_pentium_cmov_exists = false;
  int kdu_mmx_level = 0;
  int kdu_get_mmx_level() { return 0; }
  bool kdu_sparcvis_exists = get_sparcvis_exists();
  bool kdu_get_sparcvis_exists() { return get_sparcvis_exists(); }
  bool kdu_altivec_exists = false;
  bool kdu_get_altivec_exists() { return false; }
...
# include <sys/sysctl.h>
  ...
  bool kdu_get_altivec_exists() { return get_altivec_exists(); }
