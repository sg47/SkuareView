  ...
  public: // Lifecycle member functions
    KDU_AUX_EXPORT
      ...
      /* [SYNOPSIS]
           ...
           [//]
           If you never retract the multi-threading environment supplied via
           the `env' argument (can be done by passing NULL to `set_thread_env'),
  ...
  public: // Functions used to identify the elements of the composited image
    ...
    KDU_AUX_EXPORT bool
      ...
      /* [SYNOPSIS]
         ...
         [ARG: max_region_layers]
           ...
           `visible_packet_samples' and `max_visible_packet_samples' statistics.
      */
    KDU_AUX_EXPORT kdu_ilayer_ref
    ...
    KDU_AUX_EXPORT bool load_metadata_matches();
      /* [SYNOPSIS]
           ...
           codestream and compositing layer contexts for newly arrived metadata.
           However, for a source with a massive number of codestreams or
           compositing layers, that could be very tedious.
         [RETURNS]
    ...
    /* [SYNOPSIS]
         ...
         which metadata is requested.  The anchor flags that can be meaningfully
         used are drawn from the qualifier flags passed to
