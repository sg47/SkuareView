...
#define KD_THREADLOCK_COUNT 2

#define KDU_BACKGROUND_AVAILABILITY_PROCESSING_NONE        ((int) 0)
#define KDU_BACKGROUND_AVAILABILITY_PROCESSING_DEPENDENT   ((int) 1)
#define KDU_BACKGROUND_AVAILABILITY_PROCESSING_INDEPENDENT ((int) 2)
    ...
    KDU_EXPORT kdu_thread_context *
      ...
      /* [SYNOPSIS]
         ...
         [RETURNS]
           ...
           indices `KD_THREADLOCK_GENERAL' and `KD_THREADLOCK_ROI', of
           which only the last one is probably of interest outside the
           `kdu_codestream' machinery itself.  These
...
class kdu_thread_env : public kdu_thread_entity {
  ...
  */
  public: // Member functions
    KDU_EXPORT kdu_thread_env() { return; }
    KDU_EXPORT virtual ~kdu_thread_env() { return; }
