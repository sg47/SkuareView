                                              ...
                                              kdu_dims ref_image_dims)
{
  ...
  region_min.x = (int) round(rect.origin.x * scale - 0.4);
  region_lim.x = (int) round((rect.origin.x+rect.size.width) * scale + 0.4);
  region_lim.y = ref_image_dims.size.y - (int)
    round(rect.origin.y * scale - 0.4);
  region_min.y = ref_image_dims.size.y - (int)
    round((rect.origin.y+rect.size.height) * scale + 0.4);
  kdu_dims region;
