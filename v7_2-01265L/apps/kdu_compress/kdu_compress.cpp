...
int main(int argc, char *argv[])
{
  ...
  bool mem, quiet, no_info, no_weights, no_palette;
  ...
  kdc_file_binding *inputs =
    parse_simple_args(args,ofname,record_stream,transpose,vflip,hflip,
                      ...
                      allow_periodic_trimming,allow_shorts,
                      no_info,no_weights,no_palette,
  ...
  for (iscan=inputs; iscan != NULL; iscan=iscan->next)
    {
      ...
      // SkuareView - added "args" parameter to below call
