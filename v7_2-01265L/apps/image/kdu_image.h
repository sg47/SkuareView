...
#include "kdu_args.h" // SkuareView - added includes for kdu args
                      // (needed for args parameter in image_in constructor).
...
class kdu_image_in {
  ...
  */
  public: // Member functions
    ...
    // SkuareView - added below constructor declaration (needed kdu_args parameter)
    kdu_image_in(const char *fname, kdu_args &args, kdu_image_dims &dims, int &next_comp_idx,
                 bool &vflip, kdu_rgb8_palette *palette=NULL,
                 kdu_long skip_bytes=0, bool quiet=false);
...
class kdu_image_out {
  ...
  */
  public: // Member functions
    ...
    kdu_image_out(const char *fname, kdu_args& args, kdu_image_dims &dims,
            int& next_comp_idx, bool& vflip, bool quiet=false);
      /* [SYNOPSIS]
           Attempts to open a file with the indicated name, generating an
           error message (through `kdu_error') if unsuccessful.  It
           automatically creates and installs an appropriate internal
