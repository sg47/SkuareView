...
//    of the University have the right to install and use the Kakadu softwareﬁﬁ
                           ...
                           bool quiet)
{
  ...
  if (in == NULL)
    { kdu_error e; e << "NO Image file, \"" << fname << ", does not have a "
...
// SkuareView - added below constructor implementation
/*****************************************************************************/
/*                         kdu_image_in::kdu_image_in                        */
/*          This constructor accomadates an additional args param            */
/*****************************************************************************/
    ...
    if ((suffix = strrchr(fname,'.')) != NULL)
    {
        if ((strcmp(suffix+1,"pbm") == 0) || (strcmp(suffix+1,"PBM") == 0))
            ...
            in = new raw_in(fname,dims,next_comp_idx,skip_bytes,true);
                 ...
                 (strcmp(suffix+1,"tiff")==0) || (strcmp(suffix+1,"TIFF")==0))
            in = new tif_in(fname,dims,next_comp_idx,palette,skip_bytes,quiet);
        // SkuareView - added handling for fits and h5 file extensions
        #ifdef SKA_IMG_FORMATS       
