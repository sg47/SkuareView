/*****************************************************************************/
//
//  @file: fits_kdu_image.h
//  Project: fits_to_j2k
//
//  @author Slava Kitaeff
//  @date 29/07/12.
//  @brief The file contains abstract and complementary classes. The only 
//  @brief difference from the original code is calling an additional 
//  @brief kdu_image_in constructor allowing to pass a command line for image 
//  @brief specific parameters.
